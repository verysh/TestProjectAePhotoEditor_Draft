...
final class CanvasViewController<T: PKCanvasView>: UIViewController, PKToolPickerObserver, PKCanvasViewDelegate, UIGestureRecognizerDelegate, UITextViewDelegate {
    var canvas: T!
